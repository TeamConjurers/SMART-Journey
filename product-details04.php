...
$status=0;
$sql="INSERT INTO tblpurchases02(AddT02_id,UserEmail,FromDate,ToDate,Comment,status) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status)";
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Product Details</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p class="dow">#PC-<?php echo htmlentities($result->AddT02_id);?></p>
