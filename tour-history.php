...
<div class="banner-1">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"><b>Travel Diary<b></h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Explore Your Tour History</h3>
...
<tr align="center">
<th style= "text-align:center;"><h4><b>Package Name<b></h4></th>	
<th style= "text-align:center;"><h4><b>From<b></h4></th>
<th style= "text-align:center;"><h4><b>To<b></h4></th>
<th style= "text-align:center;"><h4><b>Description<b></h4></th>
