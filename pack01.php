...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"><b>Market Place<b></h1>
	</div>
</div>
<div class="navbar01">
...
<div class="rooms">
	<div class="container">
		...
		<div class="room-bottom">
			<h3>Travelling Equipments</h3>

					
<?php $sql = "SELECT * from tblmarketplace";
