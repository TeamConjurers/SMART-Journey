...
{
$nname=$_POST['newsname'];	
$nheading=$_POST['newsheading'];
$ndescription=$_POST['newsdescription'];
$nimage=$_FILES["newsimage"]["name"];
move_uploaded_file($_FILES["newsimage"]["tmp_name"],"pacakgeimages/".$_FILES["newsimage"]["name"]);
$sql="INSERT INTO travelnews(NewsName,NewsHeading,NewsDescription,NewsImage) VALUES(:nname,:nheading,:ndescription,:nimage)";
$query = $dbh->prepare($sql);
$query->bindParam(':nname',$nname,PDO::PARAM_STR);
$query->bindParam(':nheading',$nheading,PDO::PARAM_STR);
$query->bindParam(':ndescription',$ndescription,PDO::PARAM_STR);
$query->bindParam(':nimage',$nimage,PDO::PARAM_STR);
$query->execute();
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Create News</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
