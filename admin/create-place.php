...
$sql="INSERT INTO blogplaces(Place,Location,Description,Image) VALUES(:place,:location,:description,:image)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Create Place</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
