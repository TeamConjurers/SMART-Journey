...
$sql="INSERT INTO tblmarketplace02(ProductName,ProductType,SellerDetails,ProductPrice,ProductFeatures,ProductDetails,ProductImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="productname" id="productname" placeholder="Add Product" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Product Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="producttype" id="producttype" placeholder="Product Type" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="sellerdetails" id="sellerdetails" placeholder="Seller Details" required>
									</div>
								</div>
