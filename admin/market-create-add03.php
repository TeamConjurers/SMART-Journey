...
$sql="INSERT INTO tblmarketplace04(ProductName,ProductType,SellerDetails,ProductPrice,ProductFeatures,ProductDetails,ProductImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="productname" id="productname" placeholder="Add Accommodation At" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Accommodation Type</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="producttype" id="producttype" placeholder="Accommodation Type" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label"> Accommodation Price</label>
									<div class="col-sm-8">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="productdetails" id="productdetails" placeholder="Accommodation Details" required></textarea> 
									</div>
								</div>															
<div class="form-group">
