...
<html>
<head>
<title>Upload Travellogue</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="user-blog.php">Home</a><i class="fa fa-angle-right"></i>Upload to User's Blog</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
