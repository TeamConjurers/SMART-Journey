...
echo "<script type='text/javascript'> document.location = 'enquirysuccess.php'; </script>";
}
else 
{
									...
									<div class="writ">
										<h4>ANY ENQUIRY?</h4>
											<ul>
												...
												<li class="descrip">
									<input class="special" type="text" placeholder="Describe the issue"  name="description" required="">
												</li>
