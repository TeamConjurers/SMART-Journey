...
$status=0;
$sql="INSERT INTO tblpurchases(AddT01_id,UserEmail,FromDate,ToDate,Comment,status) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status)";
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Travelling Equipments</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<form name="book" method="post">
		...
		<div class="selectroom_top">
			<h2>Save the Product to My Cart</h2>
